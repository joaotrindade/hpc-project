...
mpirun -n 16 --perhost 7 ./zombie_model zombie_config.props configs/1M/model-4-4.props
mpirun -n 25 --perhost 7 ./zombie_model zombie_config.props configs/1M/model-5-5.props
mpirun -n 32 --perhost 7 ./zombie_model zombie_config.props configs/1M/model-4-8.props
