...
mpirun -n 9 --perhost 14 ./zombie_model zombie_config.props configs/1M/model-3-3.props
mpirun -n 16 --perhost 14 ./zombie_model zombie_config.props configs/1M/model-4-4.props
